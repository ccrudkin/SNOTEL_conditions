...
with open('C:/Users/ccrud/PycharmProjects/snotel/Data/long_term_reports/{}.csv'.format(local_file)) as fo:
    data = csv.reader(fo)
    data = list(data)
...
def get_deviation(month_num):
    ...
    fo = open('C:/Users/ccrud/PycharmProjects/snotel/Data/long_term_reports/{}.csv'.format(dev_file), 'w', newline='')
    o_w = csv.writer(fo)
...
def get_snow_deviation(month_num):
    ...
    fo = open('C:/Users/ccrud/PycharmProjects/snotel/Data/long_term_reports/{}.csv'.format(fn), 'w', newline='')
    o_w = csv.writer(fo)
